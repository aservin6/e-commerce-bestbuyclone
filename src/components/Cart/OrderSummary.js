...
const OrderSummary = ({ cartValue, originalCartValue, totalItems, savings }) => {
  return (
    ...
    >
      {totalItems > 0 && (
        <div className="flex flex-col h-full pt-3 pb-5">
          ...
          <div className="border-t border-opacity-10 border-dark fixed bottom-0 bg-white left-0 w-full py-3 md:relative md:border-none md:mt-auto">
          <a
              className="bg-bestBuyYellow w-2/3 flex justify-center rounded-md py-3 mx-auto md:w-full"
              href="/checkout"
            >
