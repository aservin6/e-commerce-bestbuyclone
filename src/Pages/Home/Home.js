  ...
  return (
    <>
      {showDisclaimer && (
        ...
        >
          <span className="fixed z-50 w-full px-3 text-lg font-semibold text-center text-white -translate-x-1/2 -translate-y-1/2 md:max-w-4xl md:text-2xl top-1/3 left-1/2">
            Disclaimer: This projects API account is currently undergoing an
            approval process, some products may not load due to restricted API
            access. Click screen to continue.
          </span>
        </div>
      )}
